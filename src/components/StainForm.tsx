// ============================================================
// src/components/StainForm.tsx — Main form component
// ============================================================
      ...
      <div>
        <form onSubmit={handleSubmit} noValidate className="space-y-6">
          ...
          <div>
            <label
              htmlFor="description"
              className="block text-sm font-semibold text-ink/80 tracking-wide uppercase mb-2"
            >
              Describe the stain{" "}
            ...
            <textarea
              ...
              className="
                ...
                bg-white/60 text-sm text-ink placeholder:text-[var(--color-muted)]/60
                focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent
                resize-none transition-colors disabled:opacity-50
              "
            />
            <p className="text-right text-xs text-[var(--color-muted)] mt-1">
          ...
          <div>
            ...
            <div className="relative">
              <select
                ...
                disabled={isLoading}
                className="
                  w-full px-4 py-3 pr-10 rounded-xl border border-[var(--color-border)]
                  bg-white/60 text-sm text-ink appearance-none
                  focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent
                  transition-colors disabled:opacity-50
                  invalid:text-[var(--color-muted)]
                "
              >
          ...
          <div>
            ...
            <div className="relative">
              <select
                ...
                value={stainAge}
                onChange={(e) => {
                  setStainAge(e.target.value);
                  clearFieldError("stainAge");
                }}
                disabled={isLoading}
                className="
                  w-full px-4 py-3 pr-10 rounded-xl border border-[var(--color-border)]
          ...
          <button
            ...
            className="
              ...
              hover:bg-ink/80 active:scale-[0.98]
        ...
        {formState === "idle" && (
          <div className="hidden lg:flex flex-col items-center justify-center h-full min-h-72 rounded-2xl border-2 border-dashed border-[var(--color-border)] p-8 text-center">
            ...
            <p className="text-sm text-[var(--color-muted)] mt-2">
              Upload a photo and fill in the details to get started.
            </p>
          </div>
        )}
          ...
          <div className="bg-white/50 rounded-2xl border border-[var(--color-border)] p-6 sm:p-8">
            ...
            <div className="mt-6 pt-4 border-t border-[var(--color-border)]">
              <button
                type="button"
                onClick={handleReset}
                className="text-sm font-semibold text-[var(--color-muted)] hover:text-ink transition-colors flex items-center gap-1.5"
              >
